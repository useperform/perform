...
use Perform\BaseBundle\Form\Type\ForgotPasswordType;
use Perform\BaseBundle\Form\Type\ResetPasswordType;
use Symfony\Component\Form\FormError;
use Perform\BaseBundle\Security\ResetTokenException;
...
class PasswordController extends Controller
{
    ...
    {
        try {
            $manager = $this->get('perform_base.reset_token_manager');
            ...
            if ($form->isValid()) {
                ...
                return $this->redirectToRoute('perform_base_password_success');
            }
